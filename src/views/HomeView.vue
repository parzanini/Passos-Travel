...
<template>
	<div
		...
		<main>
					...
					<div class="flex flex-wrap items-center">
						...
						<div class="w-full lg:w-3/5 text-center">
							<img
								...
								class="w-full rounded-3xl md:p-4 p-2 max-w-full"
								width="800"
								height="400" />
						</div>
					</div>
			...
			<section
				class="snap-start min-h-screen py-4 md:py-12 px-3 md:px-4 bg-white flex items-center">
				<div class="container mx-auto">
					<div class="flex flex-wrap -mx-4">
						<div class="w-full lg:w-1/3 px-4 mb-8 lg:mb-0">
							...
							<p class="mb-4">
								We are excited to help you plan your next trip. Fill out the
							...
							<img
								...
								class="w-full rounded-3xl p-4 max-w-full hidden lg:block"
								width="400"
								height="300" />
						</div>
								...
								<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
									...
									<div class="md:col-span-2">
										...
										<Textarea
											...
											class="w-full text-sm mobile-one-row"
											rows="3" />
									</div>
									<div class="md:col-span-2">
										<Button
			...
			<section
				class="snap-start min-h-screen flex flex-col justify-between bg-gray-100">
