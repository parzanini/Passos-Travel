export default {
  en: {
    title: "Welcome to Passos Travel!",
    subtitle: "Turning your travel dreams into reality!",
    description: [
    ...
    contactAlternative: "If you prefer, contact us by phone or Whatsapp. We are available to answer all your questions and help you find the best travel option for you.",
    formLabels: {
      name: "Name: *",
      email: "Email: *",
      phone: "Phone: *",
